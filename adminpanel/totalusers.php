...
var options = {
  ...
  data: [{
    ...
    type: "spline",
    dataPoints: [
      { x: new Date(2018, 0), y: 0 }, //Jan
      { x: new Date(2018, 1), y: 0 }, //Feb
      { x: new Date(2018, 2), y: 0 }, //March
      { x: new Date(2018, 3), y: 0 }, //April
      { x: new Date(2018, 4), y: 0 }, //May
      { x: new Date(2018, 5), y: 1 }, //June
      { x: new Date(2018, 6), y: 100 }, //July
      { x: new Date(2018, 7), y: 1000 }, //Aug
      { x: new Date(2018, 8), y: 5000 }, //Sept
      { x: new Date(2018, 9), y: 10000 },  //Oct
      { x: new Date(2018, 10), y: 15000 }, //Nov
      { x: new Date(2018, 11), y: 25000 } //Dec
    ]
  }]
};
